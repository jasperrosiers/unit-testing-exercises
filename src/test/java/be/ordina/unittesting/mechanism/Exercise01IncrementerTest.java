...
class Exercise01IncrementerTest {
    ...
    @Test
    void assertJ_given_minus_1_should_throw_an_illegal_argument_exception() {
        // arrange
        Incrementer incrementer = new Incrementer();
    ...
    @Test
    void junit5_given_minus_1_should_throw_an_illegal_argument_exception() {
        // arrange
        Incrementer incrementer = new Incrementer();

        // act
        Exception exception = org.junit.jupiter.api.Assertions.assertThrows(
                IllegalArgumentException.class, () -> incrementer.compute(-1));

        // assert
        Assertions.assertThat(exception).hasMessage("'-1' isn't allowed.");
    }
